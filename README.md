...
5. Create report and Escalate ticket to SOC Level 2

      ![Target Device: Report and Escalate Ticket](Report_and_Escalte_Ticket.png "Create a Report and Escalate Ticket to SOC Level 2")
